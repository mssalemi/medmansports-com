    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-24 text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link href="/projects" className="rounded-md bg-accent-gold px-4 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-gold-light focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold transition-all duration-300">
            View My Work
          </Link>
      ...
      <section className="py-24">
        <div className="grid items-center gap-16 md:grid-cols-2">
          <div>
            <p className="font-semibold accent-gold">The Engineer</p>
            ...
            <div className="mt-6">
              <Link href="/projects" className="accent-gold hover-gold font-semibold">
                Explore My Work →
              </Link>
            </div>
          </div>
      ...
      <section className="py-24">
        <div className="grid items-center gap-16 md:grid-cols-2">
          ...
          <div className="md:order-first">
            <p className="font-semibold accent-gold">The Athlete</p>
            ...
            <div className="mt-6">
              <Link href="/log" className="accent-gold hover-gold font-semibold">
                Follow My Journey →
              </Link>
            </div>
          </div>
